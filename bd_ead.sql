...
'<p>Independente de ser um desenvolvedor freelancer ou um time de desenvolvimento de software já maduro, um item especial ao
 ...
 como executar testes automatizados sobre astbl_autortbl_autortbl_autortbl_autortbl_autor suas funcionalidades e disponibilizá-lo para a equipe de testes em vários
...
as select 
 ...
 tbl_livro.vl_preco,
  ...
  select nm_livro, vl_preco,ds_capa from vw_livro where ds_categoria = "S";
